...
// This renders MapComponent on server, but MapComponent itself is a client component
  ...
  return (
    <main className="min-h-screen bg-slate-100">
        ...
        <div className="mx-auto flex w-full max-w-[1600px] items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Same tools, centered on Los Angeles.
            </p>
          </div>
      ...
      <section className="mx-auto w-full max-w-[1600px] px-6 py-6">
        <MapComponent center={[-118.2437, 34.0522]} zoom={11} />
      </section>
    </main>
  );
}
